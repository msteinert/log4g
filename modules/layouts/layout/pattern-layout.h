...
typedef struct Log4gPatternLayout_ Log4gPatternLayout;

typedef struct Log4gPatternLayoutClass_ Log4gPatternLayoutClass;
 ...
 */
struct Log4gPatternLayoutClass_ {
	/*< private >*/
