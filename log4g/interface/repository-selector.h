...
#define LOG4G_REPOSITORY_SELECTOR(instance) \
	(G_TYPE_CHECK_INSTANCE_CAST((instance), \
		LOG4G_TYPE_REPOSITORY_SELECTOR, Log4gRepositorySelector))

#define LOG4G_IS_REPOSITORY_SELECTOR(instance) \
	(G_TYPE_CHECK_INSTANCE_TYPE((instance), \
		LOG4G_TYPE_REPOSITORY_SELECTOR))
...
typedef struct Log4gRepositorySelector_ Log4gRepositorySelector;

typedef struct Log4gRepositorySelectorInterface_
	Log4gRepositorySelectorInterface;
 ...
 */
struct Log4gRepositorySelectorInterface_ {
	/*< private >*/
